...
typedef struct
{
    ...
    int     format;         ///< V4L_PIX_FMT_* format
...
//--------------------------------------------------------------------------
///
/// A 24-bit RGB component pixel  EDL modified from char to unsigned char
///
//--------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
///
/// Saves the frame to a PNM file for external viewing. For now dealing only 
/// with YUYV frame format
///
